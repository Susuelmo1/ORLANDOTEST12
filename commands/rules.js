...
module.exports = {
  ...
  async execute(interaction) {
    const rulesEmbed = new EmbedBuilder()
      ...
      .setDescription('Welcome to the ERLC Alting Server! Please follow the rules below to keep everything calm and steady. Violations will result in warnings and penalties.')
      .addFields(
        { 
